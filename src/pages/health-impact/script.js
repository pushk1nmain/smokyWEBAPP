...
(function() {
    ...
    const goForward = () => {
        ...
        // Переход на экран системы трансформации
        console.log('🔄 Переходим на экран системы трансформации');
        
        if (window.LoadingManager?.navigateWithTransition) {
            window.LoadingManager.navigateWithTransition('../system-explanation/index.html');
        } else {
