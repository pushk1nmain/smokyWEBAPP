...
(function() {
    ...
    const navigateToNextScreen = async (nicotineType) => {
        ...
        // Обновляем шаг в БД на 12 (переход к калькулятору)
        try {
            if (window.StepRouter) {
                console.log('🔄 Обновляем шаг до 12 после выбора никотина');
            ...
            console.error('❌ Ошибка при обновлении шага после выбора никотина:', error);
        }
