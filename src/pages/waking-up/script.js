...
class WakingUpScreen {
    ...
    navigateToNextScreen() {
        ...
        // 1. Переход к следующей странице истории
        // 2. Отправка данных на сервер
        // 3. Обновление состояния приложения
        
        console.log('📍 Переход к следующему этапу истории');
        
        // Пример: переход на следующую страницу
        // window.location.href = '../next-screen/index.html';
        
        // Или закрытие WebApp с результатом
        if (window.Telegram?.WebApp) {
            window.Telegram.WebApp.sendData(JSON.stringify({
                action: 'waking_up_completed',
